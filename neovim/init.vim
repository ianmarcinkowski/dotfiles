...
" Disabled because I hate this behaviour
" filetype plugin indent on   "allow auto-indenting depending on file type

" Old .vimrc custom stuff
set spelllang=en
set directory=~/.vim/swap//,.
set backspace=0
set tabstop=4
set shiftwidth=4 " same as set sw=4
...
" Uncommon features.  Color column at 80 and 100 columns
if exists(':cc')
    set cc=80,100
endif
